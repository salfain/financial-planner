const VINN_CONFIG = Object.freeze({
  ...
  HEADERS: {
    ...
    Bills: ['id', 'name', 'amount', 'category', 'account_id', 'frequency', 'due_date', 'reminder_days', 'status', 'last_paid_period', 'created_at', 'updated_at', 'liability_account_id', 'duration_months', 'paid_count', 'installment_phases_json'],
